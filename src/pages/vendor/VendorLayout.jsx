...
const navItems = [
  ...
  { label: 'My Bookings', href: '/vendor/bookings', icon: '📋' },
  { label: 'My Profile', href: '/vendor/profile', icon: '👤' },
]
    ...
    <div className="min-h-screen bg-deep flex">
      ...
      <aside className="w-64 bg-deep-2 border-r border-gold/10 flex flex-col fixed top-0 left-0 h-full z-50">
        ...
        <div className="px-6 py-5 border-b border-gold/10">
          ...
          <p className="text-brand-dim text-xs mt-0.5">Vendor Portal</p>
        </div>
        ...
        <div className="p-4 border-t border-gold/10">
          <div className="flex items-center gap-3 mb-3 px-2">
            ...
            <div>
              ...
              <div className="text-brand-dim text-xs">Vendor</div>
            </div>
          </div>
